export const AboutSection = () => (
  <section
    ...
    <div className="relative max-w-xl before:absolute before:-left-10 before:-top-10 before:h-12 before:w-16 before:border-l-8 before:border-t-8 before:border-zinc-300 before:content-[''] after:absolute after:-bottom-10 after:-right-10 after:h-12 after:w-16 after:border-b-8 after:border-r-8 after:border-zinc-300 after:content-[''] lg:max-w-3xl tallscreen:w-2/3">
      <h1 className="pb-4 text-center text-9xl font-bold text-zinc-900 tallscreen:text-6xl">
        Hi. I'm <br />
        Jose Tow
      </h1>
